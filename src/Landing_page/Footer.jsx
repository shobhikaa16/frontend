...
function Footer() {
  return (
    <div className="container-fluid  border-top mt-5 bg-light">
      <div className="row mt-5 p-10">
        <div className="col">
          <img
            src="/images/logo.svg"
            alt=""
      ...
      <div className="mt-5 text-muted p-10" style={{ fontSize: "10px" }}>
        <p>
